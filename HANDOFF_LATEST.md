...
- 未完成：正式 Catalog/Service 唯一权威切换、生产 migration 授权、Preview SHA parity（尚未推送远端）、独立 Critic/Evaluator、PR #142 推送和 `main` 合并。
...
- 当前本地候选 HEAD 为 `8cfe383e`，远端候选/PR #142 仍为 `5b419e98`，所以 `project:status` 预期失败，不能声称已同步。
