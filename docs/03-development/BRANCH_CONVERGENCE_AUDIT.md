...
**Status:** Historical graph audit; current release candidate is tracked separately
**Generated:** 2026-08-25T14:26:01Z
**Historical product reference:** `codex/unified-rc-visual-v1`
...
- Keep PR #141 as migration evidence, not as the main release entry.
- Resolve remaining ledger rows before turning the candidate `codex/main-core-foundation-v1 → main` Draft PR into Ready.
