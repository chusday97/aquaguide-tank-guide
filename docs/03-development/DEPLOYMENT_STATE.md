...
- The latest candidate is `9bdf2726`; it is pushed and synchronized with the remote candidate and PR #142. Exact Preview parity for this head is not claimed until a matching deployment is available. Production migration, Catalog publication, business-data writes and `main` merge remain unauthorized.
