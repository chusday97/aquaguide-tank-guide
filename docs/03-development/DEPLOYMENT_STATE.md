...
- The latest local changes are committed at `510244d1` but are not yet pushed. The remote candidate and PR #142 still point to the previous head; Preview parity for this new head is therefore not claimed. Production migration, Catalog publication, business-data writes and `main` merge remain unauthorized.
