...
| Current state | `.ai/PROJECT_STATE.json` plus `npm run project:status` | Branch, remote SHA, PR head and preview are checked at runtime; hashes are not duplicated in mutable prose. |
