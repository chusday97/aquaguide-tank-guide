...
| GitHub convergence CI | Product Golden Path run `33082541017`, both Foundation runs, Cloudflare Pages and Vercel checks passed on the latest reviewed candidate | Pass | Any later commit must receive a fresh exact-head run. |
