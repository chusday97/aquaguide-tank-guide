...
| Exact Preview SHA parity | The latest accepted Vercel Preview deployment is required to report the exact candidate SHA; local 4319 metadata is runtime-derived | Pending final deployment record | After the final candidate push, record the deployment ID/SHA pair and keep it immutable for release review. |
