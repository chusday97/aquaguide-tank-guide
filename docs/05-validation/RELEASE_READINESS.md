...
| GitHub convergence CI | Fresh checks are running on the latest pushed candidate; older green runs do not cover later commits | Pending | Wait for all current checks on the exact PR head. |
