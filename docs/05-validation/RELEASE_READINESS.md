...
| Exact Preview SHA parity | Vercel Preview deployment `6125077687` completed successfully at exact SHA `ed0e4f2f35ff2240e08bde237213f678cfce10a8`; local 4319 metadata matches | Pass | Any later commit must produce a new exact-SHA deployment record. |
