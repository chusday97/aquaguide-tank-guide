...
| GitHub convergence CI | PR #142 candidate head `b929be59`; foundation runs `33041753905`, `33041755993` and Product Golden Path `33041756115` all passed | Pass | Keep the same head through Preview/Supabase parity and release acceptance. |
