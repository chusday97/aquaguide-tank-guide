...
| Exact Preview SHA parity | Vercel deployment `6125319822` reports Preview target `https://aquaguide-cbgacfcef-chusday97s-projects.vercel.app` at exact candidate SHA `02457dd2` | Pass | Keep this deployment evidence paired with the reviewed candidate; any new push requires a new exact-head check. |
