...
| Exact Preview SHA parity | Vercel CLI identifies the latest Ready branch Preview and exposes `githubCommitSha=6b0e629d8b6694a06b98182a38da01d34718c44f`; canonical local/GitHub SHA is `43f75e739655e8061fb880ed3415b741a90275c1` | Pending | Trigger/observe a Git-connected Preview for `43f75e739655e8061fb880ed3415b741a90275c1`, then re-run `vercel ls aquaguide --json` and record the matching deployment. |
