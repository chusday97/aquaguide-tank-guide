...
# The old fixture waited for a conditional Aquarium CTA. Use the explicit Settings building meta-action instead:
# it is stable for this seed and still proves that a visible dialog action opens a real dialog.
...
new="""  await page.goto(`${baseUrl}/settings`, { waitUntil: 'domcontentloaded' });
