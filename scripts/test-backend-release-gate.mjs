...
const gates = [
  ...
  ['Compatibility Evidence Coverage', 'npm', ['run', 'test:compatibility-evidence-coverage']],
  ...
  // Vision provider validation is intentionally excluded from this backend integration candidate while image recognition is frozen.
  ...
  ['Aquarium Creation Semantics', 'node', ['--import', 'tsx', 'scripts/test-aquarium-creation-semantics.ts']],
  ['Livestock Removal Replay', 'node', ['--import', 'tsx', 'scripts/test-livestock-removal-replay.ts']],
  ...
  ['Local State Import Badcases', 'node', ['--import', 'tsx', 'scripts/test-local-state-import-badcases.ts']],
  ['API Offline Recovery', 'node', ['--import', 'tsx', 'scripts/test-api-offline-recovery.ts']],
