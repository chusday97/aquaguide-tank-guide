...
profile_anchor = "const profiles: Record<string, ReviewedCompatibilityProfile> = {"
sources = """const channaRhodeusInformationDynamicsStudy: EvidenceSourceDto = {
...
"""
text = replace_once(text, profile_anchor, sources + profile_anchor, 'evidence source insertion')

pair_end = "]\n\nexport const getReviewedCompatibilityProfile"
# The source actually closes the pairRules array with `];`; keep the semicolon in the anchor.
pair_end = "];\n\nexport const getReviewedCompatibilityProfile"
new_rule = """  {
...
export const getReviewedCompatibilityProfile"""
text = replace_once(text, pair_end, new_rule, 'pair rule insertion')
