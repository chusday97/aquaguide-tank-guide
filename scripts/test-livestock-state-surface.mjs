...
const [roster, taskSurface] = await Promise.all([
...
assert.ok(taskSurface.includes('w-[50vw]'), 'desktop task flow must use half of the viewport');
...
console.log('Livestock state surface verified: full-width editing inside a desktop half drawer, mobile task behavior preserved.');
