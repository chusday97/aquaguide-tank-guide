...
assert.match(serializedHealth, /"shareReportsConfigured":true/, 'production share-report service must have its dedicated signing secret and admin database capability configured');
...
console.log(`RC1 post-deploy smoke PASS for ${baseUrl}: frontend HTML + configured business/share-report API + JSON API 404 boundary.`);
