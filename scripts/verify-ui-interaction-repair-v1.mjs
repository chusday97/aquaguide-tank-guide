...
try {
  ...
  // 2) Species detail is truly full-screen on phone, with no horizontal overflow.
  {
    ...
    assert.ok(box.width >= 385, `Phone species detail must use the viewport width; got ${box.width}px.`);
