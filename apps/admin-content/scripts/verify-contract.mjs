...
const [appSource, batchSource, baseSource, supabaseSource, migrationSource, groupMigrationSource, envExample, reviewEnvExample, catalogRaw, groupsRaw] = await Promise.all([
