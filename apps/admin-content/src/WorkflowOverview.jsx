...
export default function WorkflowOverview({ overview, activeFilter, onFilter }) {
  ...
  return (
    <section className="workflow-overview">
      <div className="workflow-overview-head"><div><p className="eyebrow">EDITORIAL WORKFLOW</p><h2>内容与复核总览</h2></div><small>Readiness 按 486 条 Species；Data Review 按 33 个问题项。</small></div>
