...
const zh = {
  ...
  sidebar: { content: '内容', species: '物种页面', records: '个品种页面', batchGroups: '个模板组', workflowFilter: '当前筛选', search: '搜索名称、学名、品种或 key…', allCategories: '全部种类', noMatch: '没有匹配的基础种。', pages: '个品种页面', baseSpecies: '基础模板', inheritsBase: '使用模板', dataIssue: '存在待复核的数据问题' },
  editor: { base: '基础模板', currentPage: '当前页面', contentVersion: '内容版本', seo: '搜索展示', pageContent: '页面正文', advancedSeo: '高级 SEO', metaTitle: 'Meta 标题', metaDescription: 'Meta 描述', h1: '页面 H1', focusKeyword: '目标关键词', sharedIntro: '基础种简介', variantIntro: '当前品种补充', imageAlt: '图片 Alt', indexUrl: '索引与 URL', indexStrategy: '收录策略', canonicalTarget: '主页面', publicUrl: '页面 URL', canonical: 'Canonical', sourceReview: '数据问题', publishCheck: '发布资格', translation: '中英文转化', batchSeo: '批量 SEO', history: '版本历史', workflow: '任务队列' },
  preview: { title: '效果预览', page: '页面', google: 'Google', mobile: '手机', empty: '选择物种后查看前端效果。', generate: '生成预览', blockedHint: '完成阻塞项后可生成预览', reviewHint: '完成审核后可生成预览', previewOnly: '仅预览 · 不收录 · 源数据只读', overview: '物种概览与饲养', care: '饲养要点', temperature: '水温', tank: '建议缸体', difficulty: '难度' },
};
const en = {
  ...
  top: { product: 'AquaGuide Content', section: 'Species SEO', dataReview: 'Data Review', awaiting: 'Awaiting Review', previewReady: 'Preview-ready', reviewMode: 'Read-only demo', admin: 'Admin', signOut: 'Sign out', interfaceLanguage: 'Interface language' },
  ...
  editor: { base: 'Base template', currentPage: 'Current page', contentVersion: 'Content version', seo: 'SEO', pageContent: 'Page content', advancedSeo: 'Advanced SEO', metaTitle: 'Meta Title', metaDescription: 'Meta Description', h1: 'Page H1', focusKeyword: 'Focus Keyword', sharedIntro: 'Base species intro', variantIntro: 'Variant intro / differences', imageAlt: 'Image Alt', indexUrl: 'Indexing & URL', indexStrategy: 'Index strategy', canonicalTarget: 'Canonical target', publicUrl: 'Public URL', canonical: 'Canonical', sourceReview: 'Data Review', publishCheck: 'Publish readiness', translation: 'Chinese → English', batchSeo: 'Batch SEO', history: 'Revision history', workflow: 'Work queues' },
  preview: { title: 'Preview', page: 'Page', google: 'Google', mobile: 'Mobile', empty: 'Select a Species to see the frontend result.', generate: 'Generate Preview', blockedHint: 'Resolve blockers to generate a Preview', reviewHint: 'Complete review to generate a Preview', previewOnly: 'Preview only · Noindex · Source data read-only', overview: 'Overview & Care', care: 'Care essentials', temperature: 'Temperature', tank: 'Tank', difficulty: 'Difficulty' },
};
