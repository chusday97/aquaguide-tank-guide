...
const zh = {
  ...
  sidebar: { content: '内容', species: 'Species SEO 页面', records: '个品种页面', batchGroups: '个公共内容组', workflowFilter: '当前筛选', search: '搜索名称、学名、品种或 key…', allCategories: '全部种类', noMatch: '没有匹配的基础种。', pages: '个品种页面', baseSpecies: '基础种公共内容', inheritsBase: '沿用基础种', dataIssue: '存在待复核的数据问题' },
  editor: { base: '基础种公共内容', currentPage: '当前品种页面', contentVersion: '内容版本', seo: '搜索展示', pageContent: '页面正文', advancedSeo: '高级 SEO', metaTitle: 'Meta 标题', metaDescription: 'Meta 描述', h1: '页面 H1', focusKeyword: '目标关键词', sharedIntro: '基础种公共简介', variantIntro: '当前品种补充', imageAlt: '图片 Alt', indexUrl: '索引与 URL', indexStrategy: '收录策略', canonicalTarget: '主页面', publicUrl: '页面 URL', canonical: 'Canonical', sourceReview: '数据问题', publishCheck: '发布资格', translation: '中英文转化', batchSeo: '批量 SEO', history: '版本历史', workflow: '任务队列' },
