...
### Main convergence
- 恢复候选分支的 `.ai/PROJECT_STATE.json`、canonical 文档路由、`project:status`、`check:project-truth` 和候选分支 CI；当前 delivery line 为 `codex/main-core-foundation-v1 → main`，Draft PR #142 已创建，PR #141 仅保留为历史迁移证据。
