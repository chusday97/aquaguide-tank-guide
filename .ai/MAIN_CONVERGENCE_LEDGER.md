...
| Domain compatibility authority foundation | unified plan | `PARTIAL_WITH_FALLBACK` | `2e8d3ceb`, `5eaba64a`; `packages/domain-rules/src/compatibility.ts`, `npm run test:domain-compatibility`; legacy UI engine remains adapter |
