...
- Candidate CI initially exposed two contract gaps (Catalog tuple typing and explicit compatibility-record failure state); both are fixed locally and require the next remote run for confirmation.
