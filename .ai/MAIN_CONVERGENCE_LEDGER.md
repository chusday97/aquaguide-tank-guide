...
- Candidate CI exposed four contract gaps (Catalog tuple typing, explicit compatibility-record failure state, non-empty-tank detail routing, and the portal/quantity/confirmation Golden Path contract); all are fixed in `2b841e95`. The current docs-synchronized candidate head is `b929be59`, with runs `33041753905`, `33041755993`, `33041756115` passing.
