...
All defined P0 work and P1 Change Impact Preview are closed locally/Preview-accepted. The first unfinished milestone is **P1 Compatibility Admin**: operator management for Species behavior profiles, Pair Rules, Evidence, Confidence, Review Status and Rule Version.
