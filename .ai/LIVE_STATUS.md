...
- Workflow is now permanently compact at the top: 46px desktop / 64px mobile. Editor/Preview interaction no longer changes workflow height and no expand/focus control exists.
