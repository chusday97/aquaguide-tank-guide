...
19. [NEXT] Aqua Operations Studio Phase 3: task-critical readiness / decision surfacing. Show the exact publish/review blocker and next operator decision at the task boundary; keep low-frequency utilities secondary and preserve existing write authorities.
