...
| Compatibility evidence coverage boundary | `origin/main` batches #1–#3; `9f7fed5d`, `87251111`, `19ef8d62`, `df4ad1cc` | `MIGRATED_LOCAL_VERIFIED` | Selectively retained the reviewed-profile/pair-evidence boundary and coverage checks in the canonical line. The current P0 tree also preserves stage-risk evidence that the main-only snapshot would remove; do not cherry-pick the main branch wholesale. |
