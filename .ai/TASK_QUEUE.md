...
- [ ] 完成授权 Supabase schema/RLS 只读 parity；Vercel 最新已验证 Preview 仍为 `9f1a543c…`，当前 canonical head（以 `npm run project:status` 为准；本轮为 `2d8dce2c…`）尚无匹配部署，严格 exact Preview SHA parity pending。
