...
- [x] 新增 `npm run check:preview-parity`，自动比较 local/remote/Vercel branch Preview SHA；应用 head `b2613bdd` 曾为 `PASS`，文档 head `6df43a50` 当前因 Vercel Hobby 限额为 `NOT_SYNCHRONIZED`，不把旧 Preview 误报为通过。
