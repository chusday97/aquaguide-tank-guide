# AquaGuide Handoff — 2026-08-18 / PUI-BC-039
...
### PUI-BC-039 — Data & backup treated cloud mode as local-only
...
- Registry target: `PUI-BC-039`, `aquarium_setup`, `high`, `ui_persistence_contract`, `regression_verified`.
