...
- [ ] Run `34769711811` 因 FAQ 选择器问题失败；修复后的 Run `34769937634` 仍在浏览器专项步骤以退出码 1 失败，GitHub 未登录页面未提供失败日志正文。不能计为浏览器门禁通过。Critic 可读六维报告、Figma Canonical、性能完整基线和索引门禁仍未完成。
