...
export const phase2Batch31Knowledge = Object.fromEntries(Object.entries(phase2Batch31Subjects).map(([id, subject]) => [id, makeKnowledge(subject)])) as Record<string, SpeciesKnowledgeProfile['knowledge']>;
