...
export function SpeciesLanding() {
  ...
  return <SeoPageShell>
    ...
    {profile.editorial?.habitat && <section id="habitat" className="seo-section" aria-labelledby="habitat-title"><SectionHeading id="habitat-title" number={sectionNumber('habitat')} eyebrow={labels.habitat} title={profile.editorial.habitat.heading} description={labels.chapterSignatures.habitat} /><div className="seo-editorial-pair mt-8"><div className="seo-habitat-visual" aria-hidden="true"><span className="seo-habitat-visual__eyebrow">环境观察</span><span className="seo-habitat-visual__title">水体 · 空间 · 稳定</span><div className="seo-habitat-visual__facts"><span className="seo-habitat-visual__fact">水体</span><span className="seo-habitat-visual__fact">空间</span><span className="seo-habitat-visual__fact">稳定</span></div><span className="seo-habitat-visual__orb seo-habitat-visual__orb--one" /><span className="seo-habitat-visual__orb seo-habitat-visual__orb--two" /></div><div className="seo-card seo-large-card p-6"><p className="seo-body font-bold">{profile.editorial.habitat.summary}</p>{profile.editorial.habitat.details && <ul className="mt-5 grid gap-3 text-sm font-normal leading-7 text-ink/62">{profile.editorial.habitat.details.map(detail => <li key={detail} className="flex gap-3"><span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-accent/55" />{detail}</li>)}</ul>}</div></div></section>}
