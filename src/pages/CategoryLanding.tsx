...
export default function CategoryLanding() {
  ...
  return <SeoPageShell>
    ...
    <header className="seo-hero__content seo-page-intro max-w-[760px]"><p className="seo-eyebrow">物种分类</p><h1 className="seo-hero__title mt-3">{page.category.name}</h1><p className="seo-lead mt-5">从基础身份开始，先找到你真正想了解的物种，再进入它自己的百科档案。</p></header>
