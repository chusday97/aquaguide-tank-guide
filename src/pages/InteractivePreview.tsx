...
export default function InteractivePreview() {
  ...
  return (
    <main data-workspace-layout="standalone" className="workspace--standalone interactive-preview-shell min-h-[100dvh] bg-[#dfe8e5] px-4 py-5 text-ink md:px-8 md:py-8" data-preview-module={module}>
      ...
      <section className="mx-auto max-w-[1440px]" aria-label={`${activeMeta.label}预览`}>
        ...
        {module === 'aquarium' && <div className="relative min-h-[min(78dvh,820px)] overflow-hidden rounded-[28px] border border-white/80 bg-[#eaf5f1] shadow-sm">
