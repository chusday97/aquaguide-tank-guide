...
const observations: Record<KnowledgeObjectId, KnowledgeObservation[]> = {
  ...
  livestock: [
    { id: 'gasping', label: '多条鱼浮头或急促呼吸', labelEn: 'Multiple fish are gasping or breathing rapidly', urgency: 'urgent', topicId: 'qa_gen_020', latestCareGuideId: 'care_09', searchQuery: '浮头 呼吸急促' },
    { id: 'aggression', label: '追咬、啄咬或持续打架', labelEn: 'Chasing, nipping, or persistent fighting', urgency: 'watch', topicId: 'qa_gen_008', latestCareGuideId: 'care_18', searchQuery: '追咬 打架 求偶' },
    ...
    { id: 'white_spots', label: '体表白点、蹭缸或明显病灶', labelEn: 'White spots, flashing, or visible body lesions', urgency: 'watch', topicId: 'qa_gen_011', latestCareGuideId: 'care_10', searchQuery: '白点 蹭缸' },
  ],
  filter: [
