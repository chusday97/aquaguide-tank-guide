          ...
          <div className="app-scrollbar-hidden min-h-0 overflow-y-auto px-4 py-4 md:px-5">
                ...
                <section key={batch.id} className="rounded-[20px] border border-border/80 bg-bg/55 p-3">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex gap-1">
                      ...
                      <button type="button" onClick={() => setPendingDelete(batch)} aria-label={t('livestock.deleteGroupLabel', { index: index + 1 })} className="flex h-11 w-11 items-center justify-center rounded-xl text-rose-600 hover:bg-rose-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-300"><Trash2 className="h-4 w-4" /></button>
                    </div>
                  </div>
            ...
            {splitSource && (
              <section className="mt-4 rounded-[20px] border border-amber-200 bg-amber-50 p-4">
                <div className="flex items-start justify-between gap-3"><div><h3 className="text-sm font-black text-amber-950">{t('livestock.splitTitle')}</h3><p className="mt-1 text-xs font-semibold text-amber-900/60">{t('livestock.currentGroup', { count: splitSource.quantity })}</p></div><button type="button" onClick={() => setSplitSource(null)} className="flex h-11 w-11 items-center justify-center rounded-xl text-amber-900/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400" aria-label={t('common.close')}><X className="h-4 w-4" /></button></div>
