...
import { AlertTriangle, BookOpen, Box, Calculator, CheckCircle2, ChevronLeft, ChevronRight, Flame, Heart, HeartOff, Info, Share2, Skull, SlidersHorizontal, Thermometer, Waves, X } from 'lucide-react';
                    ...
                    <div className="grid min-w-0 grid-cols-1 min-[760px]:grid-cols-[minmax(280px,1.05fr)_minmax(0,0.95fr)]">
                      ...
                      <div className="flex min-w-0 flex-col p-3 min-[760px]:justify-center min-[760px]:p-6">
                        ...
                        <div className="mt-2 flex flex-wrap gap-2 min-[760px]:mt-3">
                          ...
                          {onViewSpeciesPage && (
                            <button type="button" onClick={onViewSpeciesPage} className="flex min-h-10 items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 text-[11px] font-black text-emerald-800 hover:bg-emerald-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400">
                              <BookOpen className="h-4 w-4" />
                              {isEn ? 'Open species page' : '打开完整物种页'}
                            </button>
                          )}
                          {onRecordDeath && (
                            <button
