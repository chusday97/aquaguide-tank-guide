...
export function AdaptiveDetailContent({ className, workspace = false, ...props }: AdaptiveDetailContentProps) {
  ...
  return (
    <DialogContent
      ...
      portal={!workspace || isPhoneLayout}
      className={cn(
        ...
        isPhoneLayout
          ...
          : workspace
            ? 'relative inset-auto z-auto h-full min-h-0 w-full max-h-none max-w-none translate-x-0 translate-y-0 rounded-none border-0 border-l border-border/70 shadow-none data-open:animate-none data-closed:animate-none'
