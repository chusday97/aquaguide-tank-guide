    ...
    <DialogContent
      ...
      className={cn(
        ...
        isPhoneLayout
          ...
          : 'bottom-0 left-auto right-0 top-0 h-[100dvh] max-h-[100dvh] w-[50vw] min-w-[520px] max-w-none translate-x-0 translate-y-0 rounded-none rounded-l-[28px] data-open:zoom-in-100 data-closed:zoom-out-100 data-open:slide-in-from-right-full data-closed:slide-out-to-right-full',
        className,
      )}
      {...props}
    />
